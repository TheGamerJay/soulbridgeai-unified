...
class RateLimiter:
    ...
    def _increment_redis(self, key: str, window_size: int, limit: int) -> Tuple[int, int, int]:
    ...
    def _increment_memory(self, key: str, window_size: int, limit: int) -> Tuple[int, int, int]:
...
def rate_limit(endpoint_key: str = None, custom_limit: int = None, custom_window: int = None):
    """
