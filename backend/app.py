...
COMPANIONS_NEW = [
    ...
    {"id":"sky_silver","name":"Sky","tier":"silver","image_url":"/static/logos/Sky_a_premium_companion.png","min_referrals":0,"greeting":"Hello! I'm Sky. With enhanced features at your fingertips, let's soar to new heights together!"},
    ...
    {"id":"watchdog_silver","name":"WatchDog","tier":"silver","image_url":"/static/logos/WatchDog_a_Premium_companion.png","min_referrals":0,"greeting":"Greetings! I'm WatchDog. I'll keep watch over your premium experience and help you stay on track."},
    {"id":"rozia_silver","name":"Rozia","tier":"silver","image_url":"/static/logos/Rozia_Silver.png","min_referrals":0,"greeting":"Hello! I'm Rozia. I bring elegance and sophistication to your SoulBridge journey."},
        ...
        if request.method == "GET":
            ...
            try:
                ...
                access = {
                    ...
                    "limits": {"decoder": 3, "fortune": 3, "horoscope": 3}
                }
...
def ai_image_generation_generate():
    ...
    try:
        ...
        # Check tier-based usage limit using AI_IMAGE_LIMITS from constants
...
def ai_image_generation_usage():
    ...
    try:
        ...
        # For Gold users, show 999 limit but still use credits for trial users
        if ai_image_tier == 'gold' and not (trial_active and user_plan == 'bronze'):
            # Real Gold subscribers get unlimited
            monthly_limit = AI_IMAGE_LIMITS.get('gold', 999999)  # Always unlimited for Gold
        elif artistic_time > 0:
            # Credit-based limits for Silver users and Bronze trial users
        ...
        # Handle display limits - show tier limits for UI, but use actual limits for functionality
        if ai_image_tier == 'gold':
            # Gold tier always shows 999 in UI, even for Bronze trial users
            display_limit = 999
            if monthly_limit >= 999999:
                # Real Gold users get unlimited remaining
                remaining = 999  
            else:
                # Bronze trial users on Gold tier show actual remaining credits
                remaining = max(0, monthly_limit - monthly_usage)
        else:
            # Silver and Bronze tiers show actual limits
...
# ========================================
# THEME PERSISTENCE API ENDPOINTS (REMOVED - DUPLICATE FUNCTIONS)
