...
class ReferralManager:
    def __init__(self):
        self.referral_rewards = {
            'referrer': {
                2: {'type': 'exclusive_companion', 'value': 'Blayzike', 'description': 'Unlock Blayzike companion'},
                4: {'type': 'exclusive_companion', 'value': 'Blazelian', 'description': 'Unlock Blazelian companion'},
                6: {'type': 'special_skin', 'value': 'Blayzo_Referral', 'description': 'Unlock Blayzo special referral skin'}
            },
            'referee': {
                'signup': {'type': 'welcome_bonus', 'value': 'none', 'description': 'Welcome to SoulBridge AI!'}
            }
        }
    ...
    def create_referral_link(self, user_email: str, base_url: str = "https://soulbridgeai.com") -> Dict:
    ...
    def process_referral_signup(self, referee_email: str, referral_code: str, referrer_email: str) -> Dict:
    ...
    def check_referrer_rewards(self, user_email: str, new_referral_count: int) -> List[Dict]:
    ...
    def grant_reward(self, user_email: str, reward: Dict) -> Dict:
        ...
        try:
            ...
            if reward['type'] in ['premium_days', 'premium_months']:
                days = reward['value'] if reward['type'] == 'premium_days' else reward['value'] * 30
