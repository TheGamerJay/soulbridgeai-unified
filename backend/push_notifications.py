...
class PushNotificationManager:
    ...
    def create_notification_payload(self, notification_type: str, user_data: Dict = None, custom_data: Dict = None) -> Dict:
        ...
        if user_data:
            ...
            if notification_type == 'companion_missing':
                base_notification['title'] = base_notification['title'].format(companion_name=companion_name)
    ...
    def schedule_notification(self, user_id: str, notification_type: str, delay_minutes: int = 0, user_data: Dict = None) -> Dict:
    ...
    def get_retention_notifications(self, user_id: str, last_active: datetime, user_data: Dict = None) -> List[Dict]:
        ...
        if time_since_active >= timedelta(days=1) and time_since_active < timedelta(days=2):
        ...
        elif time_since_active >= timedelta(days=3) and time_since_active < timedelta(days=5):
            notifications.append({
    ...
    def create_notification_schedule(self, user_id: str, user_data: Dict = None) -> Dict:
