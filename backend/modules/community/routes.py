...
def auto_set_avatar(companion_id):
    ...
    try:
        ...
        companion_map = {
            ...
            'blayzo_bronze': {'name': 'Blayzo', 'image_url': '/static/companions/blayzo.png', 'tier': 'bronze'},
            ...
            'blayzica_bronze': {'name': 'Blayzica', 'image_url': '/static/companions/blayzica.png', 'tier': 'bronze'},
            'blayzia_bronze': {'name': 'Blayzia', 'image_url': '/static/companions/blayzia.png', 'tier': 'bronze'},
            'blayzion_bronze': {'name': 'Blayzion', 'image_url': '/static/companions/blayzion.png', 'tier': 'bronze'},
            'blayzo2_bronze': {'name': 'Blayzo.2', 'image_url': '/static/companions/blayzo2.png', 'tier': 'bronze'},
            ...
            # SILVER  
            'sky_silver': {'name': 'Sky', 'image_url': '/static/companions/sky.png', 'tier': 'silver'},
            'gamerjay_silver': {'name': 'GamerJay.2', 'image_url': '/static/companions/gamerjay_premium.png', 'tier': 'silver'},
            'claude_silver': {'name': 'Claude.3', 'image_url': '/static/companions/claude_growth.png', 'tier': 'silver'},
            'rozia_silver': {'name': 'Rozia', 'image_url': '/static/companions/rozia.png', 'tier': 'silver'},
            'blayzo_silver': {'name': 'Blayzo.3', 'image_url': '/static/companions/blayzo_premium.png', 'tier': 'silver'},
            'blayzica_silver': {'name': 'Blayzica.2', 'image_url': '/static/companions/blayzica_pro.png', 'tier': 'silver'},
            'lumen_silver': {'name': 'Lumen.2', 'image_url': '/static/companions/lumen_silver.png', 'tier': 'silver'},
            'watchdog_silver': {'name': 'WatchDog', 'image_url': '/static/companions/watchdog.png', 'tier': 'silver'},
            # GOLD
            'crimson_gold': {'name': 'Crimson', 'image_url': '/static/companions/crimson_max.png', 'tier': 'gold'},
            'violet_gold': {'name': 'Violet', 'image_url': '/static/companions/violet_max.png', 'tier': 'gold'},
            'claude_gold': {'name': 'Claude.2', 'image_url': '/static/companions/claude_max.png', 'tier': 'gold'},
            'royal_gold': {'name': 'Royal', 'image_url': '/static/companions/royal.png', 'tier': 'gold'},
            'ven_sky_gold': {'name': 'Ven Sky', 'image_url': '/static/companions/ven_sky.png', 'tier': 'gold'},
            'ven_blayzica_gold': {'name': 'Ven Blayzica', 'image_url': '/static/companions/ven_blayzica.png', 'tier': 'gold'},
            'watchdog_gold': {'name': 'WatchDog.2', 'image_url': '/static/companions/watchdog_max.png', 'tier': 'gold'},
            'dr_madjay_gold': {'name': 'Dr. MadJay', 'image_url': '/static/companions/dr_madjay.png', 'tier': 'gold'},
            'lumen_gold': {'name': 'Lumen.3', 'image_url': '/static/companions/lumen_gold.png', 'tier': 'gold'},
            # REFERRAL COMPANIONS
            'blayzike': {'name': 'Blayzike', 'image_url': '/static/companions/blayzike.png', 'tier': 'bronze'},
            'blazelian': {'name': 'Blazelian', 'image_url': '/static/companions/blazelian.png', 'tier': 'silver'},
...
def anonymous_community():
    ...
    try:
        ...
        # Companion mapping for fixing bad data - CORRECTED PATHS
        companion_map = {
            # BRONZE
            'gamerjay_bronze': {'name': 'GamerJay', 'image_url': '/static/images/companions/gamerjay.png', 'tier': 'bronze'},
            'blayzo_bronze': {'name': 'Blayzo', 'image_url': '/static/images/companions/blayzo.png', 'tier': 'bronze'},
            'claude_bronze': {'name': 'Claude', 'image_url': '/static/images/companions/claude.png', 'tier': 'bronze'},
            'lumen_bronze': {'name': 'Lumen', 'image_url': '/static/images/companions/lumen.png', 'tier': 'bronze'},
            'blayzica_bronze': {'name': 'Blayzica', 'image_url': '/static/images/companions/blayzica.png', 'tier': 'bronze'},
            'blayzia_bronze': {'name': 'Blayzia', 'image_url': '/static/images/companions/blayzia.png', 'tier': 'bronze'},
            'blayzion_bronze': {'name': 'Blayzion', 'image_url': '/static/images/companions/blayzion.png', 'tier': 'bronze'},
            'blayzo2_bronze': {'name': 'Blayzo.2', 'image_url': '/static/images/companions/blayzo2.png', 'tier': 'bronze'},
            'crimson_bronze': {'name': 'Crimson', 'image_url': '/static/images/companions/crimson.png', 'tier': 'bronze'},
            'violet_bronze': {'name': 'Violet', 'image_url': '/static/images/companions/violet.png', 'tier': 'bronze'},
            # SILVER  
            'sky_silver': {'name': 'Sky', 'image_url': '/static/images/companions/sky.png', 'tier': 'silver'},
            'gamerjay_silver': {'name': 'GamerJay.2', 'image_url': '/static/images/companions/gamerjay_premium.png', 'tier': 'silver'},
            'claude_silver': {'name': 'Claude.3', 'image_url': '/static/images/companions/claude_growth.png', 'tier': 'silver'},
            'rozia_silver': {'name': 'Rozia', 'image_url': '/static/images/companions/rozia.png', 'tier': 'silver'},
            'blayzo_silver': {'name': 'Blayzo.3', 'image_url': '/static/images/companions/blayzo_premium.png', 'tier': 'silver'},
            'blayzica_silver': {'name': 'Blayzica.2', 'image_url': '/static/images/companions/blayzica_pro.png', 'tier': 'silver'},
            'lumen_silver': {'name': 'Lumen.2', 'image_url': '/static/images/companions/lumen_silver.png', 'tier': 'silver'},
            'watchdog_silver': {'name': 'WatchDog', 'image_url': '/static/images/companions/watchdog.png', 'tier': 'silver'},
            # GOLD
            'crimson_gold': {'name': 'Crimson', 'image_url': '/static/images/companions/crimson_max.png', 'tier': 'gold'},
            'violet_gold': {'name': 'Violet', 'image_url': '/static/images/companions/violet_max.png', 'tier': 'gold'},
            'claude_gold': {'name': 'Claude.2', 'image_url': '/static/images/companions/claude_max.png', 'tier': 'gold'},
            'royal_gold': {'name': 'Royal', 'image_url': '/static/images/companions/royal.png', 'tier': 'gold'},
            'ven_sky_gold': {'name': 'Ven Sky', 'image_url': '/static/images/companions/ven_sky.png', 'tier': 'gold'},
            'ven_blayzica_gold': {'name': 'Ven Blayzica', 'image_url': '/static/images/companions/ven_blayzica.png', 'tier': 'gold'},
            'watchdog_gold': {'name': 'WatchDog.2', 'image_url': '/static/images/companions/watchdog_max.png', 'tier': 'gold'},
            'dr_madjay_gold': {'name': 'Dr. MadJay', 'image_url': '/static/images/companions/dr_madjay.png', 'tier': 'gold'},
            'lumen_gold': {'name': 'Lumen.3', 'image_url': '/static/images/companions/lumen_gold.png', 'tier': 'gold'},
            # REFERRAL COMPANIONS
            'blayzike': {'name': 'Blayzike', 'image_url': '/static/images/companions/blayzike.png', 'tier': 'bronze'},
            'blazelian': {'name': 'Blazelian', 'image_url': '/static/images/companions/blazelian.png', 'tier': 'silver'},
            'nyxara': {'name': 'Nyxara', 'image_url': '/static/images/companions/nyxara.png', 'tier': 'silver'},
            'claude_referral': {'name': 'Claude Referral', 'image_url': '/static/images/companions/claude_referral.png', 'tier': 'gold'},
            'blayzo_referral': {'name': 'Blayzo Referral', 'image_url': '/static/images/companions/blayzo_referral.png', 'tier': 'gold'},
            # BAD DATA FIXES - Map incorrect IDs to correct base companions
            'lumen_bronze': {'name': 'Lumen', 'image_url': '/static/images/companions/lumen.png', 'tier': 'bronze'},
            'rozia_bronze': {'name': 'Rozia', 'image_url': '/static/images/companions/rozia.png', 'tier': 'bronze'},
            'claude_bronze': {'name': 'Claude', 'image_url': '/static/images/companions/claude.png', 'tier': 'bronze'},
            'gamerjay_bronze': {'name': 'GamerJay', 'image_url': '/static/images/companions/gamerjay.png', 'tier': 'bronze'},
            'blayzion_bronze': {'name': 'Blayzion', 'image_url': '/static/images/companions/blayzion.png', 'tier': 'bronze'},
            'crimson_bronze': {'name': 'Crimson', 'image_url': '/static/images/companions/crimson.png', 'tier': 'bronze'},
            'violet_bronze': {'name': 'Violet', 'image_url': '/static/images/companions/violet.png', 'tier': 'bronze'},
            'sky_bronze': {'name': 'Sky', 'image_url': '/static/images/companions/sky.png', 'tier': 'bronze'},
            'royal_bronze': {'name': 'Royal', 'image_url': '/static/images/companions/royal.png', 'tier': 'bronze'},
        }
