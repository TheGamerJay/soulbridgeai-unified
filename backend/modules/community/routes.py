...
def auto_set_avatar(companion_id):
    ...
    try:
        ...
        companion_map = {
            # BRONZE
            'gamerjay_bronze': {'name': 'GamerJay', 'image_url': '/static/logos/gamerjay.png', 'tier': 'bronze'},
            'blayzo_bronze': {'name': 'Blayzo', 'image_url': '/static/logos/blayzo.png', 'tier': 'bronze'},
            'claude_bronze': {'name': 'Claude', 'image_url': '/static/logos/claude.png', 'tier': 'bronze'},
            'lumen_bronze': {'name': 'Lumen', 'image_url': '/static/logos/lumen.png', 'tier': 'bronze'},
            ...
            'blayzo2_bronze': {'name': 'Blayzo.2', 'image_url': '/static/logos/blayzo2.png', 'tier': 'bronze'},
            'crimson_bronze': {'name': 'Crimson', 'image_url': '/static/logos/crimson.png', 'tier': 'bronze'},
            'violet_bronze': {'name': 'Violet', 'image_url': '/static/logos/violet.png', 'tier': 'bronze'},
            # SILVER  
            'sky_silver': {'name': 'Sky', 'image_url': '/static/logos/sky.png', 'tier': 'silver'},
            'gamerjay_silver': {'name': 'GamerJay.2', 'image_url': '/static/logos/gamerjay_premium.png', 'tier': 'silver'},
            'claude_silver': {'name': 'Claude.3', 'image_url': '/static/logos/claude_growth.png', 'tier': 'silver'},
            'rozia_silver': {'name': 'Rozia', 'image_url': '/static/logos/rozia.png', 'tier': 'silver'},
            'blayzo_silver': {'name': 'Blayzo.3', 'image_url': '/static/logos/blayzo_premium.png', 'tier': 'silver'},
            ...
            'watchdog_silver': {'name': 'WatchDog', 'image_url': '/static/logos/watchdog.png', 'tier': 'silver'},
            # GOLD
            'crimson_gold': {'name': 'Crimson', 'image_url': '/static/logos/crimson_max.png', 'tier': 'gold'},
            'violet_gold': {'name': 'Violet', 'image_url': '/static/logos/violet_max.png', 'tier': 'gold'},
            'claude_gold': {'name': 'Claude.2', 'image_url': '/static/logos/claude_max.png', 'tier': 'gold'},
            'royal_gold': {'name': 'Royal', 'image_url': '/static/logos/royal.png', 'tier': 'gold'},
            'ven_sky_gold': {'name': 'Ven Sky', 'image_url': '/static/logos/ven_sky.png', 'tier': 'gold'},
            'ven_blayzica_gold': {'name': 'Ven Blayzica', 'image_url': '/static/logos/ven_blayzica.png', 'tier': 'gold'},
            'watchdog_gold': {'name': 'WatchDog.2', 'image_url': '/static/logos/watchdog_max.png', 'tier': 'gold'},
            'dr_madjay_gold': {'name': 'Dr. MadJay', 'image_url': '/static/logos/dr_madjay.png', 'tier': 'gold'},
            'lumen_gold': {'name': 'Lumen.3', 'image_url': '/static/logos/lumen_gold.png', 'tier': 'gold'},
            # REFERRAL COMPANIONS
            'blayzike': {'name': 'Blayzike', 'image_url': '/static/logos/blayzike.png', 'tier': 'bronze'},
            'blazelian': {'name': 'Blazelian', 'image_url': '/static/logos/blazelian.png', 'tier': 'silver'},
            'nyxara': {'name': 'Nyxara', 'image_url': '/static/logos/nyxara.png', 'tier': 'silver'},
            'claude_referral': {'name': 'Claude Referral', 'image_url': '/static/logos/claude_referral.png', 'tier': 'gold'},
            'blayzo_referral': {'name': 'Blayzo Referral', 'image_url': '/static/logos/blayzo_referral.png', 'tier': 'gold'},
        }
...
def anonymous_community():
    ...
    try:
        ...
        companion_map = {
            ...
            'lumen_bronze': {'name': 'Lumen', 'image_url': '/static/logos/lumen.png', 'tier': 'bronze'},
            'rozia_bronze': {'name': 'Rozia', 'image_url': '/static/logos/rozia.png', 'tier': 'bronze'},
            'claude_bronze': {'name': 'Claude', 'image_url': '/static/logos/claude.png', 'tier': 'bronze'},
            'gamerjay_bronze': {'name': 'GamerJay', 'image_url': '/static/logos/gamerjay.png', 'tier': 'bronze'},
            'blayzion_bronze': {'name': 'Blayzion', 'image_url': '/static/logos/blayzion.png', 'tier': 'bronze'},
            'crimson_bronze': {'name': 'Crimson', 'image_url': '/static/logos/crimson.png', 'tier': 'bronze'},
            'violet_bronze': {'name': 'Violet', 'image_url': '/static/logos/violet.png', 'tier': 'bronze'},
            'sky_bronze': {'name': 'Sky', 'image_url': '/static/logos/sky.png', 'tier': 'bronze'},
            'royal_bronze': {'name': 'Royal', 'image_url': '/static/logos/royal.png', 'tier': 'bronze'},
        }
