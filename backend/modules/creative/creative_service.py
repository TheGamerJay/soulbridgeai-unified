            ...
            if self.client:
                try:
                    ...
                    style_configs = {
                        ...
                        "lyrics": {
                            "character": "You are a world-class Song Lyricist and producer with technical mastery, creating cinematic, professional-quality songs with raw emotional impact.",
                            "instruction": f"Create a cinematic, professional-quality song based on: '{prompt}'. The vocals must combine technical mastery with raw feeling:\n\n• RHYME MASTERY: Complex multi-syllabic rhyme schemes, internal rhymes, and clever punchlines\n• WORDPLAY: Unexpected and impactful lines with double/triple meanings, multi-entendres, and cultural wordplay\n• STORYTELLING: Smooth storytelling with vivid word-painting, metaphors, and allegories that unfold like movie scenes\n• FLOW: Perfect prosody - every syllable should lock naturally into the rhythm\n• VOCAL DYNAMICS: Include delivery instructions and ad-libs using proper notation\n• STRUCTURE: Strong contrast between sections (soft intros, powerful choruses, haunting bridges, confessional outros)\n• CHORUSES: Make them anthemic and universal while verses remain intricate and layered\n• TITLE: Add a compelling, memorable song title\n\nIMPORTANT FORMATTING:\n• Use [brackets] for vocal delivery instructions: [whisper], [echo], [fast], [melodic], [emotional], [soft], [powerful]\n• Use (parentheses) for ad-libs and background vocals: (yeah), (uh-huh), (that's right), (money calls)\n• Section labels: [Title], [Intro], [Verse 1], [Chorus], [Verse 2], [Bridge], [Outro]\n\nDeliver studio-quality, radio-ready lyrics with proper vocal notation and cinematic emotional impact."
                        },
                        "poem": {
