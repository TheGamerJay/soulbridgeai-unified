            ...
            if self.client:
                try:
                    ...
                    style_configs = {
                        ...
                        "lyrics": {
                            "character": "You are a world-class Song Lyricist and producer with technical mastery, creating cinematic, professional-quality songs with raw emotional impact in any language.",
                            "instruction": f"Create a cinematic, professional-quality song based on: '{prompt}'. \n\nLANGUAGE HANDLING:\n• If prompt is in ONE language: Write entirely in that language\n• If prompt contains MULTIPLE languages: Create bilingual lyrics with natural code-switching\n• If user explicitly requests bilingual (e.g., 'Spanish-English song'): Mix languages authentically\n• Maintain cultural authenticity and natural flow for each language used\n\nThe vocals must combine technical mastery with raw feeling:\n\n• RHYME MASTERY: Complex multi-syllabic rhyme schemes, internal rhymes, and clever punchlines\n• WORDPLAY: Unexpected and impactful lines with double/triple meanings, multi-entendres, and cultural wordplay appropriate to the language\n• STORYTELLING: Smooth storytelling with vivid word-painting, metaphors, and allegories that unfold like movie scenes\n• FLOW: Perfect prosody - every syllable should lock naturally into the rhythm of the target language\n• VOCAL DYNAMICS: Include delivery instructions and ad-libs using proper notation\n• STRUCTURE: Strong contrast between sections (soft intros, powerful choruses, haunting bridges, memorable outros that resolve the story)\n• CHORUSES: Make them anthemic and universal while verses remain intricate and layered\n• TITLE: Add a compelling, memorable song title in the same language\n\nIMPORTANT FORMATTING:\n• Use [brackets] for vocal delivery instructions: [whisper], [echo], [fast], [melodic], [emotional], [soft], [powerful]\n• Use (parentheses) for ad-libs and background vocals appropriate to the language\n• Section labels: [Title], [Intro], [Verse 1], [Chorus], [Verse 2], [Bridge], [Outro]\n\nIMPORTANT: Take time to craft a powerful, memorable outro that provides emotional resolution and leaves lasting impact. Don't rush the ending - make it as strong as the rest of the song.\n\nDeliver studio-quality, radio-ready lyrics with proper vocal notation and cinematic emotional impact in the user's language."
                        },
                        "poem": {
                    ...
                    # Direct OpenAI call with increased tokens for lyrics (more room for full songs)
                    max_tokens = 1500 if style == "lyrics" else 800
